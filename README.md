...
|---------|-------------|------------|
| [**PIRS**](https://github.com/roshnrf/PIRS) | 9-layer insider threat detection pipeline with RL interventions | ROC-AUC **0.8554** on 1.3M records |
| [**StoryWeaver**](https://github.com/roshnrf/StoryWeaver) | AI speech therapy for children ages 4–6 using Whisper + Gemini | **88%** ASR accuracy |
...
ML/AI        → PyTorch, Scikit-learn, Reinforcement Learning, NLP, Whisper
Cloud        → AWS (Lambda, S3, Rekognition, DynamoDB), Azure
Databases    → PostgreSQL, DynamoDB, Supabase, Redis
...
[![Medium](https://img.shields.io/badge/Medium-000?style=flat&logo=medium&logoColor=white)](https://medium.com/@rosh003)
[![Email](https://img.shields.io/badge/Email-EA4335?style=flat&logo=gmail&logoColor=white)](mailto:roshanabdlrf03@gmail.com)
